...
T: dict[str, dict[str, str]] = {
    ...
    "common.delete":   {"ru": "Удалить",      "uz": "Oʻchirish"},
    "common.edit":     {"ru": "Изменить",     "uz": "Tahrirlash"},
    "common.archive":  {"ru": "В архив",      "uz": "Arxivga"},
    "common.delete_confirm": {"ru": "Удалить? Действие необратимо.",
                              "uz": "Oʻchirilsinmi? Amalni qaytarib boʻlmaydi."},
    "common.remove":   {"ru": "Убрать",       "uz": "Olib tashlash"},
    ...
    "cust.delete_confirm":{"ru": "Удалить клиента? Он исчезнёт из списка (история сохранится).",
                           "uz": "Mijoz oʻchirilsinmi? Roʻyxatdan yoʻqoladi (tarix saqlanadi)."},
    ...
    "act.btn.topup_vip":{"ru":"Пополнить VIP","uz":"VIP-ni toʻldirish"},
    "act.pick_product": {"ru":"Выберите продукт","uz":"Mahsulotni tanlang"},
    ...
    "act.vip.cancel":   {"ru":"Отменить абонемент","uz":"Obonementni bekor qilish"},
    "act.vip.cancel_confirm":{"ru":"Отменить VIP-абонемент клиента? Остаток депозита не возвращается автоматически.",
                              "uz":"Mijozning VIP-obonementini bekor qilamizmi? Depozit qoldigʻi avtomatik qaytarilmaydi."},
    ...
    "act.add":          {"ru": "Добавить",   "uz": "Qoʻshish"},
    "act.pay_cashback": {"ru": "Оплата кэшбэком", "uz": "Keshbek bilan toʻlov"},
    "act.pay_cashback.all": {"ru": "Весь", "uz": "Hammasi"},
    "act.pay_cashback.hint": {"ru": "Доступно {bal} {ccy}. Спишется не больше суммы чека; остаток — наличными/картой.",
                              "uz": "Mavjud {bal} {ccy}. Chek summasidan oshmaydi; qolgani — naqd/karta."},
    ...
    "prod.edit":        {"ru":"Редактировать продукт","uz":"Mahsulotni tahrirlash"},
    "prod.search_ph":   {"ru":"Поиск по названию или SKU…","uz":"Nomi yoki SKU boʻyicha qidirish…"},
    ...
    "br.edit":          {"ru":"Редактировать точку","uz":"Filialni tahrirlash"},
    ...
    "staff.col.username":{"ru":"Username",    "uz":"Username"},
    "staff.col.phone":  {"ru":"Телефон",      "uz":"Telefon"},
    ...
    "staff.edit":       {"ru":"Редактировать сотрудника","uz":"Xodimni tahrirlash"},
    "staff.search_ph":  {"ru":"Поиск по имени или username…","uz":"Ism yoki username boʻyicha qidirish…"},
    "staff.password.keep":{"ru":"оставьте пустым — без изменений","uz":"boʻsh qoldiring — oʻzgarmaydi"},
    "staff.role.barista":{"ru":"бариста (вход в Telegram-бот по PIN)",
                          "uz":"barista (Telegram-botga PIN bilan kirish)"},
    "staff.role.owner": {"ru":"владелец (вход в web-админку)",
                         "uz":"egasi (web-adminga kirish)"},
    "staff.username":   {"ru":"Username",     "uz":"Username"},
    "staff.pin":        {"ru":"PIN (4–6 цифр, только для бариста)",
                         "uz":"PIN (4–6 raqam, faqat barista uchun)"},
    ...
    "login.username":   {"ru":"Логин",        "uz":"Login"},
